  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Zdravstvene informacije o psu {name}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="mt-6">
          <p className="text-sm text-muted-foreground">
            Vsi psi v našem zavetišču so pred oddajo veterinarsko pregledani, cepljeni proti steklini, mikročipirani ter tretirani proti notranjim in zunanjim zajedavcem.
          </p>
        </div>
      </CardContent>
    </Card>
