...
export default function FeaturedAnimals() {
  ...
  const totalSlides = Math.ceil(featuredAnimals.length / slidesToShow);
  ...
  // Calculate visible animals based on active slide
    ...
    >
      <div className="relative">
        <div className="overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-normal">
