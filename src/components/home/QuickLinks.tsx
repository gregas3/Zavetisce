...
export default function QuickLinks() {
  return (
    <div className="py-8 bg-gradient-to-b from-teal-50/90 to-teal-100/70 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {links.map((link, index) => (
            ...
            >
              <Link
                to={link.link}
                className="group p-6 md:p-8 rounded-xl border border-teal-200/60 bg-white/90 backdrop-blur-sm flex flex-col h-full hover-lift overflow-hidden relative shadow-sm hover:shadow-md transition-all duration-300"
              >
