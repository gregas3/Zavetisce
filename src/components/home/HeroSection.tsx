...
export default function HeroSection() {
  ...
  return <div className="relative pt-16 min-h-[90vh] flex items-start overflow-hidden">
      ...
      {/* Content */}
      <div className="container mx-auto px-4 relative z-10 mt-10 md:mt-16">
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 cursor-pointer" onClick={scrollToNextSection} aria-label="Scroll down">
