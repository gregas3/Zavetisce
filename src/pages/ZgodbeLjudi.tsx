...
const ZgodbeLjudi = () => {
  ...
  return (
    <Layout className="bg-gradient-to-b from-[#f0f9f7]/90 to-[#e8f6f4]/90">
      <Helmet>
        <title>Zgodbe ljudi | Zavetišče za živali Maribor</title>
        <meta 
          name="description" 
          content="Resnične zgodbe ljudi, ki so posvojili živali, prostovoljcev in sprehajalcev psov iz Zavetišča za živali Maribor." 
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-12">
        <AnimatedWrapper animation="fade-in" className="mb-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-teal-700/90 text-lg">
              Spoznajte resnične zgodbe ljudi, ki so posvojili živali iz našega zavetišča,
              naših prostovoljcev in sprehajalcev psov. Delite tudi svojo zgodbo z nami!
            </p>
          </div>
        </AnimatedWrapper>
        ...
        <div className="mt-12 text-center">
          ...
          <a 
            href="mailto:zavetisce.mb@snaga-mb.si?subject=Moja%20zgodba%20za%20Zgodbe%20ljudi" 
            className="bg-teal-600 hover:bg-teal-700 text-white font-medium py-3 px-6 rounded-lg transition-all hover:scale-105 inline-flex items-center gap-2"
          >
            <Quote size={18} />
